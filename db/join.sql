...
value (0, '테스트도서관', '999(테스트)', '테스트도서명', '9999', '9999', '2023', '999.9-테99ㅌ');
...
from
	library_mst lm 
    left outer join publisher_mst pm on(pm.publisher_id = lm.출판사)	-- inner join + on () 둘다 추가하여 공통된 조건들 출력.  A join B 왼쪽과 오른쪽의 두항을 붙여 줄것이다.
-- where
