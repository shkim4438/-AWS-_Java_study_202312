...
public class ArrayListMain {
	...
	public static void main(String[] args) {
		 ...
		 * Arrays.asList(배열);
		 */
		String[] langs = {"java", "c++", "python", "javascrpt"};
		...
		List<String>subList = strList.subList(1, 4);//1~4번 인덱스 전까지(0~3)
		...
		while(iterator.hasNext()) {//hasNext()값이 있는지 확인 next()값을 하나씩 꺼내는 행위.
